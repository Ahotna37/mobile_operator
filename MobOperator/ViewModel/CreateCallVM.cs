...
{
    public class CreateCallVM : INotifyPropertyChanged
    {
        ...
        public string ComboBoxWhoCallSelected
        {
            get => _comboBoxWhoCallSelected;
            set
            {
                _comboBoxWhoCallSelected = value;
                OnPropertyChanged(nameof(ComboBoxWhoCallSelected));
            }
        }
        ...
        private void MakeCall(int idUserForCall)
        {
            ...
            string incomingCallText = ComboBoxWhoCallSelected;
            bool incomingCall;
               ...
               if (client.freeMin > 0)
            {
                ...
                if (timeFree >= 0)
                {
                    ...
                    if (timeFree < 0)
                {
                    dbOperation.UpdateFreeMinForClient(idUserForCall, Convert.ToInt32(client.freeMin ));
                    switch (callType)
                    {
                        case 1:
